...
func runAllTests(ctx *TestContext) []TestResult {
	...
	testCases := []struct {
		...
		// {"Different Quota Types Test", testExpireQuotasTask_DifferentQuotaTypes},
		...
		// {"Boundary Consumption Scenarios Test", testExpireQuotasTask_BoundaryConsumptionScenarios},
